...
import (
	...
	"github.com/owncloud/ocis/v2/services/static-file-server/pkg/config"
	"github.com/owncloud/ocis/v2/services/static-file-server/pkg/config/parser"
	"github.com/owncloud/ocis/v2/services/static-file-server/pkg/logging"
...
func Server(cfg *config.Config) *cli.Command {
	return &cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			// 		return err
			// 	}
			// 	if err = json.Unmarshal(contents, &cfg.Static.Config); err != nil {
